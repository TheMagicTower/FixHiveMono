 ...
 */
import { z } from 'zod';
import { createCloudClient, hashSignature, NORMALIZATION_GUIDE, } from '@the-magic-tower/fixhive-shared';
...
Returns ranked solutions based on similarity, environment match, and community votes.`,
    inputSchema: {
        ...
        properties: {
            ...
            packages: {
                type: 'object',
                description: 'Key dependencies with versions (e.g., {"react": "18.2.0", "next": "14.0.0"})',
...
export async function handleSearchCases(input) {
...
//# sourceMappingURL=search-cases.tool.js.map